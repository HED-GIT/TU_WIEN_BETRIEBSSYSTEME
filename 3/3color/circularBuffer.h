...
{
    int state;                          //state of our program, > 0 means running, <= 0 means terminating 
    Solution values[BUFFERLENGTH];   //our circular buffer
    int writePosition;                  //next position to write to
    int readPosition;                   //next position to read from
} Buffer;
